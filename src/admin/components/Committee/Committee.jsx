...
import CommitteeForm from "../../shared/components/committee/Addandeditform";
import Tableheadpanel from "../../shared/components/committee/Tableheadpanel";
import Tableview from "../../shared/components/committee/Tableview";
...
export default function Committee(){
    ...
    const getNotification = useCallback(async ()=>{
            setLoading(true);
        try {
            const res= await getallcommittee({first,rows,globalfilter,colfilter});
            console.log('Res:',res)
    ...
    const handlesave=async (e)=>{
        ...
        await savecommittee(formDataToSend)
  ...
  try {
    ...
    await updatecommittee(formDataToSend, formdata._id);
    toast.success("Successfully updated");
    getNotification();
    setVisible(false);
  } catch (error) {
