...
export default function Heroaddandeditform({ visible, setVisible, handlesave, handlechange, loading, formdata, handleupdate, imageDataUrl, departmentOptions, loadingDepartments, fetchDepartments }) {
      ...
      <div className="w-full max-w-3xl overflow-hidden bg-white shadow-2xl rounded-xl">
        <div className="p-6 bg-blue-600">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-white">Add Promotional Material</h2>
