      ...
      <div className="w-full max-w-4xl overflow-hidden bg-white shadow-2xl rounded-2xl">
        ...
        <div className="p-6 bg-secondary">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-white lg:text-3xl">Create Category & Subcategory</h2>
            <button
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-1">
                <div className="h-full p-4 bg-gray-50 rounded-xl">
                  <label className="block w-full transition-colors bg-white border-2 border-purple-300 border-dashed cursor-pointer aspect-square rounded-xl hover:border-purple-500">
                    {
                      formdata?.Images ?
              ...
              <div className="space-y-6 lg:col-span-2">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-700">Cateory Order Show Format</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-700">Priority For Homepage show</label>
                    <select
                      name="priority_category_show"
                      value={formdata?.priority_category_show}
                      onChange={handlechange}
                      className="w-full px-4 py-3 transition-all border-0 rounded-lg outline-none bg-gray-50 focus:ring-2 focus:ring-purple-500"
                    >
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-700">Cateory Discount</label>
                    <input
                      type="text"
                      name="Category_Discount"
                      value={formdata?.Category_Discount}
                      onChange={handlechange}
                      className="w-full px-4 py-3 transition-all border-0 rounded-lg outline-none bg-gray-50 focus:ring-2 focus:ring-purple-500"
                      placeholder="Enter number"
