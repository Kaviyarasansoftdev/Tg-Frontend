...
const Tableview = (props) => {
  ...
  const showNoticeTemplate = (rowData) => {
    return (
      <div className="flex justify-center">
  ...
  const dateTemplate = (rowData) => {
    ...
    return moment(rowData.date).format('MMM DD, YYYY');
  };
  ...
  // Description Template with HTML content
  const descriptionTemplate = (rowData) => {
    if (!rowData.Description) return '-';
    
    // Truncate description if too long
    const maxLength = 100;
    const description = rowData.Description.length > maxLength 
    ...
    return (
      <div 
        ...
        title={rowData.Description} // Show full description on hover
      >
        {description}
      </div>
    );
  ...
  const columns = [
    ...
    { field: 'subtitle', header: 'Subtitle', filter: true, width: '180px' },
    { field: 'Description', header: 'Description', filter: true, width: '250px', body: descriptionTemplate },
    // { field: 'date', header: 'Date', filter: true, width: '120px', body: dateTemplate },
    { field: 'showNotice', header: 'Show Notice', filter: true, width: '120px', body: showNoticeTemplate },
    { field: 'pdf', header: 'PDF', filter: false, width: '80px', body: pdfTemplate },
    { field: 'Status', header: 'Status', filter: true, width: '120px', body: statusTemplate },
    { field: 'createdAt', header: 'Created At', filter: false, width: '150px', body: createdAtTemplate }
  ];
    ...
    <div className="p-4 bg-white border-b">
      <div className="flex items-center justify-between gap-4">
        <div className="relative flex-1 max-w-md">
          <h2 className="text-lg font-semibold text-gray-800">Naac Management</h2>
          {/* <p className="text-sm text-gray-600">Manage and view all notices</p> */}
        </div>
        <div className="flex items-center gap-3">
          <button
