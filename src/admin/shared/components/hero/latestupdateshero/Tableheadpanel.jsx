   ...
   Latest updates Image section
            ...
            <div>
              <div className="inline-flex gap-x-2">
                ...
                <button onClick={newform} className="inline-flex items-center px-3 py-2 text-sm font-semibold text-white border border-transparent rounded-lg cursor-pointer bg-green-500 gap-x-2 hover:bg-primary disabled:opacity-50 disabled:pointer-events-none">
                  ...
                  <span className="hidden md:block">Add Latest images</span> 
                </button>
              </div>
            </div>
          </div>
