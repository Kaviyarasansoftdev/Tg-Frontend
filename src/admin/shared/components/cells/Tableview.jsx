...
//   // Updated image function with proper handling for missing images
//   const image = (rowData) => {
//     // Check if Images exist and is not empty
//     if (!rowData.Images || !Array.isArray(rowData.Images) || rowData.Images.length === 0) {
//       return (
//         <div className="flex justify-center">
//           <div className="flex items-center justify-center w-24 h-16 bg-gray-100 rounded-lg">
...
//                     e.target.parentElement.innerHTML = '<div class="flex items-center justify-center w-24 h-16 bg-gray-100 rounded-lg"><span class="text-gray-400 text-xs">No Image</span></div>';
//                   }}
//                 />
//               </SwiperSlide>
//             ))}
...
//   // Link template function - add this if you need to handle links
//   const linkTemplate = (rowData) => {
//     if (!rowData.link || rowData.link.trim() === '') {
//       return (
//         <div className="flex justify-center">
...
//           title="Open Link"
//         >
//           <i className="text-lg text-blue-600 group-hover:text-blue-700 group-hover:scale-110 transition-all duration-200 fi fi-rr-link"></i>
//         </a>
//       </div>
//     );
//   };
...
//     // Add link column if needed
//     // { field: 'link', header: 'Link', filter: false, body: linkTemplate }
//   ];
