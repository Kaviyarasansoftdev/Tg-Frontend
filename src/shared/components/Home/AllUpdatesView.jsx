...
import { apigetnewsandeventsbyid } from '../../services/apihomepage/apihomepage';
import apiurl from '../../services/apiendpoint/apiendpoint';
import { Calendar, MapPin } from 'lucide-react';

export default function AllUpdatesView() {
    const { id } = useParams();
    ...
    const fetchNotification = async () => {
        try {
            setLoading(true);
            const data = await apigetnewsandeventsbyid(id);
    ...
    return (
        <div className="min-h-screen py-16">
                    ...
                    <div className="p-8">
                                    ...
                                    {notification?.Coverimage && (
                                        <div className="border border-gray-200 rounded-lg p-6 bg-white">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <button
                                                    onClick={() => handleDownload(notification.Coverimage, `${notification.Title}_image`)}
                                            ...
                                            <div className="relative">
                                                <img
                                                    src={`${apiurl()}/${notification.Coverimage}`}
                                                    alt={notification.Title}
                                                    className="w-full max-w-3xl max-h-[500px] object-contain mx-auto rounded-lg border border-gray-200 cursor-pointer hover:shadow-md transition-shadow"
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-500">
                            <div className="flex items-center gap-1">
                                ...
                                {formatDate(notification.DateandTime)}
                            </div>
                            <div className="flex items-center gap-1">
                        ...
                        <div className="prose prose-gray max-w-none" dangerouslySetInnerHTML={{ __html: notification.Content }} />
                        ...
                        <div className="border-t border-gray-200 pt-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    ...
                                    <span className={`inline-flex px-3 py-1 rounded-full text-xs font-semibold ${notification?.Status === 'Active'
            ...
            {/* Image Preview Modal */}
            {imagePreview && notification?.Coverimage && (
                <div
