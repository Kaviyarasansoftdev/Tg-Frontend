...
//             {/* Badge */}
//             <div className="mb-6">
//               <span className="text-sm font-medium text-amber-700 uppercase tracking-wide px-4 py-2 bg-amber-50 rounded-full">
//                 RTI
//               </span>
//             </div>
...
//               <span className="text-amber-600">Right to Information</span>
//             </h2>
...
//                 <h3 className="text-xl font-semibold text-gray-900 mb-2">RTI Document</h3>
//                 <p className="text-gray-600">View the official Right to Information document</p>
//               </div>
...
//                 </button>
//                 <iframe
//                   src="/documents/rti/RTI-Act-2005.pdf"
        ...
        <div className="bg-gradient-to-br from-amber-50 via-white to-yellow-50 min-h-screen py-5 pb-10">
          ...
          <div className="text-center space-y-6 mb-12 py-16">
            ...
            <p className="text-xl lg:text-2xl font-bold text-gray-900 leading-tight">
              Access official Right to Information documents and
              <span className="block text-amber-600">transparency compliance information</span>
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  Right to Information Document
                </h2>
                
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  This document outlines the official Right to Information (RTI) Act details, 
                  including procedures for accessing information, transparency measures, and institutional compliance.
                </p>

                <div className="space-y-4 mb-8">
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-amber-600 mr-3" />
                    <span>RTI Application Procedures</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-amber-600 mr-3" />
                    <span>Transparency & Accountability Measures</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-amber-600 mr-3" />
                    <span>Public Information Officer Details</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-amber-600 mr-3" />
                    <span>Institutional Compliance Records</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="bg-gradient-to-br from-amber-100 to-yellow-100 rounded-xl p-6 mb-6">
                    ...
                    <div className="text-center">
                      <h3 className="font-bold text-gray-900 mb-2">Official RTI Document</h3>
                      <p className="text-gray-600 text-sm">Transparency Compliance Document</p>
                    </div>
                  </div>
