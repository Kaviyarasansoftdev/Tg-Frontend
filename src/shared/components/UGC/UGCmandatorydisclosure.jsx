...
//    export function UgcMandatoryDisclosure() {
...
//               <span className="text-purple-600">UGC Mandatory Disclosure</span>
//             </h2>
...
//                 <h3 className="text-xl font-semibold text-gray-900 mb-2">UGC Mandatory Disclosure Document</h3>
//                 <p className="text-gray-600">View the official UGC mandatory disclosure document</p>
//               </div>
              
//               <button 
//                 onClick={openModal}
//                 className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium cursor-pointer"
//               >
//                 View Document
//               </button>
//             </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 via-white to-indigo-50 min-h-screen py-5 pb-10">
          ...
          <div className="text-center space-y-6 mb-12 py-16">
            ...
            <p className="text-xl lg:text-2xl font-bold text-gray-900 leading-tight">
              Access official UGC mandatory disclosure documents and
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  UGC Mandatory Disclosure Document
                </h2>
                
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  This document provides comprehensive details required by the University Grants Commission (UGC) 
                  regarding our institution's governance, academic programs, faculty, and financial disclosures.
                </p>

                <div className="space-y-4 mb-8">
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-purple-600 mr-3" />
                    <span>Institutional Governance & Administration</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-purple-600 mr-3" />
                    <span>Academic Programs & Accreditation</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-purple-600 mr-3" />
                    <span>Faculty Details & Qualifications</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <ChevronRight className="w-5 h-5 text-purple-600 mr-3" />
                    <span>Financial & Infrastructure Disclosures</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {/* <a 
                    href="/documents/ugc/ALL DEPT MANDATORY DISCLOSURE.pdf" 
                    download
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-xl p-6 mb-6">
                    ...
                    <div className="text-center">
                      <h3 className="font-bold text-gray-900 mb-2">Official UGC Disclosure</h3>
