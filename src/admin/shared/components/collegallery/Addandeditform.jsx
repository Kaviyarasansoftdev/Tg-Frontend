...
export default function CollegegalleryForm({ 
  visible, 
  setVisible, 
  handlesave, 
  handlechange, 
      ...
      <div className="w-full max-w-4xl max-h-[95vh] overflow-hidden bg-white shadow-2xl rounded-2xl border border-gray-100">
        ...
        <div className="p-8 overflow-y-auto max-h-[calc(95vh-140px)]">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="Images">🖼️ Image Gallery</option>
            ...
            {/* Images Upload Section - Only show if Type is Image */}
            ...
            {/* Videos Upload Section - Only show if Type is Video */}
            {formdata?.Type === 'Videos' && (
              <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl border border-red-100">
                <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                  ...
                  Gallery Videos
                  <span className="ml-2 text-sm text-gray-500">
                    ({videoPreviews?.length || 0} video{videoPreviews?.length !== 1 ? 's' : ''})
                  </span>
                </h3>
                ...
                <div className="relative mb-6">
                  ...
                  <div className="w-full px-6 py-8 bg-gradient-to-br from-red-50 to-pink-50 border-2 border-dashed border-red-300 rounded-xl text-center hover:from-red-100 hover:to-pink-100 transition-all duration-200 group">
                    <div className="text-red-600 text-4xl mb-3 group-hover:scale-110 transition-transform duration-200">🎥</div>
                    <p className="text-red-700 font-semibold text-lg mb-2">Add Gallery Videos</p>
                    <p className="text-red-600 text-sm mb-4">MP4, AVI, MOV files up to 10MB each</p>
                ...
                {videoPreviews && videoPreviews.length > 0 && (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {videoPreviews.map((preview, index) => (
                      <div key={index} className="relative group">
                        <div className="aspect-video bg-white rounded-lg border-2 border-red-200 overflow-hidden shadow-sm">
                          <video 
                            src={preview.isExisting ? `${apiurl()}/${preview.url}` : (preview.url || preview)} 
