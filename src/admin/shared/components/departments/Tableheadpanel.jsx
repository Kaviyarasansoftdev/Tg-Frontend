          ...
          <div className="items-center justify-between px-6 py-4 space-y-2 lg:flex lg:space-y-0">
              ...
              <div>
                <div className="inline-flex gap-x-2">
                  ...
                  <button onClick={newform} className="inline-flex items-center px-3 py-2 text-sm font-semibold text-white bg-green-400 border border-transparent rounded-lg gap-x-2 disabled:opacity-50 disabled:pointer-events-none cursor-pointer">
                   ...
                   <span className="hidden md:block">Add Department Overview</span> 
                  </button>
                </div>
              </div>
            </div>
