...
export default function CellsForm({ visible, setVisible, handlesave, handlechange, loading, formdata, handleupdate, pdfPreview, removePdf, imagePreviews, removeImage, addImage }) {
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-3xl font-bold text-white">
                  {formdata?._id ? 'Edit Cell' : 'Create New Cell'}
                </h2>
              </div>
              <p className="text-white/90 text-sm font-medium">
                {formdata?._id ? 'Update your cell details' : 'Add new cell information'}
              </p>
            </div>
            <button 
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Enter cell title (e.g., Research Cell, Innovation Cell)..."
                ...
                {/* Cell Description Field with Rich Text Editor */}
                <div className="space-y-2">
                  <label className="flex items-center text-sm font-semibold text-gray-800">
                  ...
                  <div className="bg-white border-2 border-gray-200 rounded-xl focus-within:border-purple-500 focus-within:ring-2 focus-within:ring-purple-200 transition-all duration-200 overflow-hidden">
                    <Editor
                      ...
                      style={{ height: '200px' }}
                      placeholder="Detailed description of the cell's purpose, objectives, and responsibilities..."
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-teal-50 p-6 rounded-xl border border-green-100">
              ...
              <div className="relative mb-6">
                ...
                <div className="w-full px-6 py-8 bg-gradient-to-br from-green-50 to-teal-50 border-2 border-dashed border-green-300 rounded-xl text-center hover:from-green-100 hover:to-teal-100 transition-all duration-200 group">
                  ...
                  <p className="text-green-700 font-semibold text-lg mb-2">Add Cell Images</p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handlechange}
                    placeholder="Enter PDF name (e.g., Cell Charter, Guidelines Document)..."
                    ...
                    <div className="flex items-center justify-center h-48 bg-gradient-to-br from-red-50 to-pink-50 rounded-lg border border-red-100">
                      <div className="text-center">
                        ...
                        <p className="text-red-600 text-sm font-medium mb-2">
                          {formdata?.pdfName || 'Cell Document'}
                        </p>
              ...
              >
                {loading ? (
                  ...
                  <span className="flex items-center justify-center">
                    {formdata?._id ? '✏️ Update Cell' : '✨ Create Cell'}
                  </span>
                )}
              </button>
