...
import Tableheadpanel from "../../shared/components/hero/welcomepopup/Tableheadpanel";
import Tableview from "../../shared/components/hero/welcomepopup/Tableview";
import Welcomepopupaddandeditform from "../../shared/components/hero/welcomepopup/Addandeditform";
import { deletewelcomepopup, getwelcomepopup, savewelcomepopup, updatewelcomepopup } from "../../shared/services/apiherobanner/apiwelcomepopup";
...
export default function WelcomePopup(){
  ...
  const [loadingDepartments, setLoadingDepartments] = useState(false);
    ...
    const getwelcomepopupdata = useCallback(async ()=>{
            setLoading(true);
        try {
            const res= await getwelcomepopup({first,rows,globalfilter,colfilter});
            console.log('Res:',res)
 ...
 useEffect(() => {
  ...
  const fetchDepartments = async () => {
    ...
    const handlesave=async (e)=>{
        e.preventDefault()
        setLoading(true)
        await savewelcomepopup(formdata)
    ...
    const handleupdate=async (e)=>{
        ...
        e.preventDefault()
        setLoading(true)
        await updatewelcomepopup(formdata)
    ...
    return(
        <div>
            <div className="bg-white border rounded-3xl">
                ...
                <Welcomepopupaddandeditform visible={visible} setVisible={setVisible} loading={loading} formdata={formdata} setFormdata={setFormdata} imageDataUrl={imageDataUrl}
