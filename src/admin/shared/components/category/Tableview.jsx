    ...
    return (
      <div className="flex justify-center">
        <div className="relative group">
          <img 
            src={`https://via.placeholder.com/96x64/4F46E5/FFFFFF?text=Dept`}
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Department ID</th>
                ...
                <tr key={row._id} className="hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <td className="px-4 py-4">
                    <div className="text-sm">
                      ...
                      <div className="text-gray-600">{row.Department_id}</div>
                    </div>
                  </td>
