...
import Heroaddandeditform from "../../shared/components/hero/herobanner/Addandeditform";
import Tableheadpanel from "../../shared/components/hero/herobanner/Tableheadpanel";
import Tableview from "../../shared/components/hero/herobanner/Tableview";
import { deleteherobanner, getallherobanner, saveherobanner, updateherobanner } from "../../shared/services/apiherobanner/apiherobanner";
...
export default function HeroBanner(){
  ...
  // Fetch departments when component mounts or becomes visible
    ...
    const getherobanner = useCallback(async ()=>{
            setLoading(true);
        try {
            const res= await getallherobanner({first,rows,globalfilter,colfilter});
            console.log('Res:',res)
    ...
    return(
        <div>
            <div className="bg-white border rounded-3xl">
                ...
                <Heroaddandeditform visible={visible} setVisible={setVisible} loading={loading} formdata={formdata} setFormdata={setFormdata} imageDataUrl={imageDataUrl}
