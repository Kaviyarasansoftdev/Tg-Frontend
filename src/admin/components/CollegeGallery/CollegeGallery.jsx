...
import Tableheadpanel from "../../shared/components/collegallery/Tableheadpanel";
import Tableview from "../../shared/components/collegallery/Tableview";
import CollegegalleryForm from "../../shared/components/collegallery/Addandeditform";


export default function CollegeGalley(){
    ...
    const getNotification = useCallback(async ()=>{
            setLoading(true);
        try {
            const res= await getallcollegegallery({first,rows,globalfilter,colfilter});
            console.log('Res:',res)
    ...
    const handlesave=async (e)=>{
        ...
        await savecollegegallery(formDataToSend)
    ...
    const handleupdate = async (e) => {
        ...
        try {
            ...
            await updatecollegegallery(formDataToSend, formdata._id);
