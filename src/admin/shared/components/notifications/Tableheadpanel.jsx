        ...
        <div className="items-center justify-between px-6 py-4 space-y-2 lg:flex lg:space-y-0">
            ...
            <div>
              <div className="inline-flex gap-x-2">
                ...
                <button onClick={newform} className="inline-flex items-center px-3 py-2 text-sm font-semibold text-white border border-transparent rounded-lg bg-green-500  gap-x-2 hover:bg-primary disabled:opacity-50 disabled:pointer-events-none cursor-pointer">
                  ...
                  <span className="hidden md:block">Add Notifictaion</span> 
                </button>
              </div>
            </div>
          </div>
