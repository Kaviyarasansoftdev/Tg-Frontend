        ...
        <div className="block md:flex items-center justify-between px-6 py-4">
            ...
            <div>
              <div className="inline-flex gap-x-2">
                ...
                <button onClick={newform} className="inline-flex items-center px-3 py-2 text-sm font-semibold text-white bg-green-400 border border-transparent rounded-lg gap-x-2 hover:bg-secondary disabled:opacity-50 disabled:pointer-events-none cursor-pointer">
